...
SRC	= 	    mx_printchar.c mx_strlen.c mx_print_unicode.c mx_printstr.c mx_printerr.c \
		    ...
		    mx_get_substr_index.c mx_count_substr.c mx_count_words.c mx_strnew.c mx_isspace.c \
		    ...
		    mx_memmem.c mx_memmove.c mx_realloc.c mx_file_length.c mx_is_positive.c mx_is_odd.c mx_isalpha.c mx_isdigit.c \
